...
###Plotly scatterplot
Create plotly scatterplot. Scatter plots have different modes. Used mutate to create a new variable called text_label. \nRating indicates new line for rating. Mapping text_lable to text. 
```{r}
nyc_airbnb %>%
